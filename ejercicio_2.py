...
def promedio(numeros):
    ...
    promedio_numeros = sumatoria_numeros / cantidad_numeros
    #try:
    # Colocar código que se desea probar
    #promedio_numeros = sumatoria_numeros / 0
    #except:
    # Error!
...
if __name__ == '__main__':
    ...
    print('El promedio calculado es:', resultado_promedio)
